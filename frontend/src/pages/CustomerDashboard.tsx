...
const CustomerDashboard = () => {
  ...
  const user = JSON.parse(localStorage.getItem('user') || '{"city": "Mumbai", "area": "Bandra", "name": "Friend"}');
            ...
            <section className="mb-14">
              ...
              {exactMatches.length === 0 ? (
                <div className="bg-white border-4 border-black p-10 text-center shadow-[4px_4px_0px_#000]">
                  <p className="font-display font-black text-3xl uppercase mb-2">Nothing in {user.area} yet</p>
                  <p className="font-medium text-gray-500">Check out restaurants from other {user.city} areas below!</p>
                </div>
              ) : (
