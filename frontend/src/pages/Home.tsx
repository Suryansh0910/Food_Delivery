...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full bg-white z-50 border-b-4 border-black flex items-center justify-between py-4 px-6 md:px-12 transition-all">
      <div className="flex items-center gap-2 bg-[#FFD700] border-4 border-black px-4 py-1 shadow-[4px_4px_0px_#000] -rotate-1 hover:rotate-0 transition-transform cursor-pointer">
      ...
      <div className="hidden md:flex items-center gap-8">
        <button className="text-black font-black uppercase text-lg hover:underline decoration-4 underline-offset-4 decoration-brand-600 border-b-0">Home</button>
        <button className="text-black font-black uppercase text-lg hover:underline decoration-4 underline-offset-4 decoration-brand-600 border-b-0">Restaurants</button>
        ...
        {user ? (
          <div className="relative hidden sm:block">
            ...
            {showDropdown && (
              ...
              >
                {/* User info header */}
                <div className="bg-[#FFD700] border-b-4 border-black px-4 py-3">
